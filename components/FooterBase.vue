<template>
  <footer class="footer p-10 bg-neutral text-neutral-content rounded-b-2xl">
    <aside>
      <div class="flex-1">
        <a class="font-semibold text-xl mt-3 flex items-center gap-2"
          ><img src="@/assets/logo-pp.svg" class="h-10" alt="" />
          <p class="-mt-3">plantpowered</p></a
        >
      </div>
      <p>Transforming meat junkies into veggie enthusiasts, one meal at a time.</p>
    </aside>
    <nav>
